...
TEST_CASE("benchmark strings c'tor operation - 4 alphabet", "[string_with_rank][!benchmark][4][time][ctor][.]") {
...
TEST_CASE("benchmark vectors symbol() operations - 4 alphabet", "[string_with_rank][!benchmark][4][time][symbol]") {
    auto const& text = generateText<0, 4>();
...
TEST_CASE("benchmark vectors rank() operations - 4 alphabet", "[string_with_rank][!benchmark][4][time][rank]") {
    auto const& text = generateText<0, 4>();
...
TEST_CASE("benchmark vectors prefix_rank() operations - 4 alphabet", "[string_with_rank][!benchmark][4][time][prefix_rank]") {
    auto const& text = generateText<0, 4>();
...
TEST_CASE("benchmark vectors all_ranks() operations - 4 alphabet", "[string_with_rank][!benchmark][4][time][all_ranks]") {
    auto const& text = generateText<0, 4>();
...
TEST_CASE("benchmark vectors all_ranks_and_prefix_ranks() operations - 4 alphabet", "[string_with_rank][!benchmark][4][time][all_ranks_and_prefix_ranks]") {
    auto const& text = generateText<0, 4>();
...
TEST_CASE("benchmark vectors in size - alphabet 4", "[string_with_rank][!benchmark][4][size]") {
    auto const& text = generateText<0, 4>();
